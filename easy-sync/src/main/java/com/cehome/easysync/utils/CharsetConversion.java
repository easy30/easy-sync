 ...
 *
 * from canal  package com.taobao.tddl.dbsync.binlog;
 */
public final class CharsetConversion {
    ...
    static Map<String,String> mysqlJavaMap=new HashMap<>();
    ...
    static void putEntry(final int charsetId, String mysqlCharset, String mysqlCollation, String javaCharset) {
        entries[charsetId] = new Entry(charsetId, mysqlCharset, // NL
            mysqlCollation,
            javaCharset);
        mysqlJavaMap.put(mysqlCharset,javaCharset);
    }
    ...
    public static String getJavaCharset(String mysqlCharset) {
        return mysqlJavaMap.get(mysqlCharset.toLowerCase());
    }
